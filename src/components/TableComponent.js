    ...
    <div className="flex flex-col mt-9 border border-gray-100 rounded">
      {cryptoData ? (
        <table className="w-full table-auto">
          <thead className="capitalize text-base text-gray-100 font-medium border border-gray-100 text-center">
            <tr>
              ...
              return (
                ...
                >
                  <td className="py-4 flex items-center uppercase">
                    ...
                    <svg
                      className="w-[1.5rem] ml-1.5 fill-gray-100 hover:fill-fuchsia"
                        width="30"
                        height="30"
                        viewBox="0 0 30 30"
                        fill="fuchsia"
